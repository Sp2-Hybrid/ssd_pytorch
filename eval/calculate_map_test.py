...
parser.add_argument('--predicted_file', default='results', type=str, help='Checkpoint state_dict file for transfer learning')
args = parser.parse_args()

annopath = os.path.join('/home/songpeng/ssd/ssd.pytorch.2/eval/Anno_test', '%s.xml')#测试集标注文件路径
test_imagesetfile = '/home/songpeng/ssd/ssd.pytorch.2/eval/core_coreless_test.txt'#测试集里面的图片名
'''
