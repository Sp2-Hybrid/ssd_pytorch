...
#train时不用写VOC_ROOT,test时为'/home/songpeng/ssd/ssd.pytorch.2'
...
def get_voc_results_file_template(image_set, cls):
    # /data/VOCdevkitVOC/results/det_test_aeroplane.txt
    if cls == 'core':
        cls = '带电芯充电宝'
    else:
        cls = '不带电芯充电宝'
